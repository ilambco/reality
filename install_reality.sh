...
# 主菜单
show_menu() {
    echo "00101101000000001101001001001010001111011001001001001001101"
    echo "111000**1110000001000**0010010****01101****110******0110100"
    echo "00110/**001011000111****00100/**/**001**/**00/*////**011000"
    echo "11000/**00001111001**//**0010/**//**0**1/**00/*100/**011101"
    echo "11110/**0100000010**10//**111/**1//***11/**00/******0101000"
    echo "10101/**011000100**********00/**10//*110/**01/*////1**00010"
    echo "01011/**11101111/**//////**00/**101/0110/**11/*1111/**01010"
    echo "10100/********01/**00110/**10/**11111010/**10/*******001011"
    echo "10001////////111//101000//111//000100010//110///////0001110"
    echo "01000111010011011111110110111011001101100001101010101101110"
    echo
    echo "================ Reality 管理菜单 ========"
    echo " 1.   添加VLESS节点"
    echo " 2.   删除VLESS节点"
